...
CREATE TABLE `fingerprint` (
  ...
  `person_id` int(11) NOT NULL COMMENT 'foreign key to person_id in person table',
  ...
  CONSTRAINT `FK_fingerprint` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
...
CREATE TABLE `person` (
  ...
  `other_name` varchar(15) DEFAULT NULL,
...
CREATE TABLE `person_identifier` (
  ...
  `identifier` varchar(38) DEFAULT NULL,
  ...
  CONSTRAINT `FK_person_identifier` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
...
CREATE TABLE `search_history` (
  ...
  CONSTRAINT `FK_search_history` FOREIGN KEY (`linked_search_id`) REFERENCES `search_history` (`search_history_id`),
  CONSTRAINT `FK_search_history_address` FOREIGN KEY (`address_id`) REFERENCES `address` (`address_id`),
  CONSTRAINT `FK_search_history_person` FOREIGN KEY (`m_person_id`) REFERENCES `person` (`person_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
...
CREATE TABLE `visit` (
  ...
  CONSTRAINT `FK_visit` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
