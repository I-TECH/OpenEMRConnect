 ...
 * July 18 2009 moved to package my.spider.util
 ...
 *   @See http://blog.lolyco.com/sean/damerau-levenshtein/
 */
public class Levenshtein {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("damlevlim(\"short\", \"shoort\", 2) = " + damlevlim("short", "shoort", 2));
        System.out.println(" " + ((damlevlim("short", "shoort", 2) == 1) ? "PASS" : "*FAIL*"));
        System.out.println("Björn Törnqvist's report damlevlim(”short”,”shrt”,2) = 2 should be 1");
        System.out.print("damlevlim(\"short\", \"shrt\", 2) = " + damlevlim("short", "shrt", 2));
        System.out.println(" " + ((damlevlim("short", "shrt", 2) == 1) ? "PASS" : "*FAIL*"));
