 ...
 * @author JGitahi
 */
public class SchemaTransactionGenerator {

    public List<SchemaTransaction> generate() throws InaccessibleConfigurationFileException, DriverNotFoundException, SQLException {
