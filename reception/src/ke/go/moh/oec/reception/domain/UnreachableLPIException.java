 ...
 */
public class UnreachableLPIException extends Exception {

    /**
     * Creates a new instance of <code>UnreachableMPIException</code> without detail message.
     */
    public UnreachableLPIException() {
        super("The Local Person Index could not be reached.");
    }
     ...
     */
    public UnreachableLPIException(String msg) {
        super(msg);
    }
}
